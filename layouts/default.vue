<template>
  ...
  >
    <v-app-bar class="app-bar">
          ...
          <v-col>
            ...
            >
              ...
              >
                ...
                <v-menu
                  v-if="item.id === 3 && store.data?.products?.length > 0"
                  activator="parent"
                >
                  <v-card min-width="80vw" min-height="300px">
                    <v-card-text>
                      <v-row>
                        <v-col
                          v-for="(item2, index2) in store.data.products"
                          :key="index2"
                          cols="2"
                          style="text-align: center"
                        >
                          <v-img :src="item2.url"></v-img><br />
                          <b style="color: #080639">{{ item2.name }}</b>
                          <br />
                          <b style="color: var(--title-color)"
                            >Giá: {{ item2.price }} <u>đ</u></b
                          >
                        </v-col>
                      </v-row>
                    </v-card-text>
      ...
      <v-btn icon @click="$router.push('/bill')">
